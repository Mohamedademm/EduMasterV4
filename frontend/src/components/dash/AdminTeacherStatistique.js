          ...
          <>
            ...
            >
              <Card className="stat-card">
                <CardContent>
                  <Typography variant="h6">Total Enseignants</Typography>
                  <Typography variant="h5">{stats.totalTeachers}</Typography>
                </CardContent>
              </Card>
              <Card className="stat-card">
                <CardContent>
                  <Typography variant="h6">Enseignants Actifs</Typography>
                  <Typography variant="h5">{stats.activeTeachers}</Typography>
                </CardContent>
              </Card>
              <Card className="stat-card">
                <CardContent>
                  <Typography variant="h6">Enseignants Inactifs</Typography>
